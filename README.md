Native OpenCV for Excise recognition
=================================

This application tested on version 3.4.1 with native OpenCV.

It gets the camera frames, make JNI calls with its gray matrices references as parameters
...
* Set the OpenCV library module up to fit your SDK
  ...
  Edit `openCVLibrary341/build.gradle` to fit your SDK:
